    ...
    <div className="container">
      ...
      <main className="main">
        <div className="page-header">
          <h1 className="page-title">Dashboard Bookmarks</h1>
        ...
        <div className="content-area">
          <div className="terminal-window">
            <div className="terminal-header">
              ...
              <span className="terminal-title">dashboard/bookmarks.tsx</span>
            </div>
            <div className="terminal-body">
              <p><span className="prompt">$</span> ls dashboard/bookmarks/</p>
