export default function GreyAreaPage() {
  return (
    <div className="container">
      ...
      <main className="main">
        <div className="page-header">
          <h1 className="page-title">Grey Area</h1>
        ...
        <div className="content-area">
          <div className="terminal-window">
            <div className="terminal-header">
              ...
              <span className="terminal-title">grey-area.tsx</span>
            </div>
            <div className="terminal-body">
              <p><span className="prompt">$</span> ls grey-area/</p>
