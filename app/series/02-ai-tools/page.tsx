export default function Series02AiToolsPage() {
  return (
    <div className="container">
      ...
      <main className="main">
        <div className="page-header">
          <h1 className="page-title">Series 02 Ai Tools</h1>
        ...
        <div className="content-area">
          <div className="terminal-window">
            <div className="terminal-header">
              ...
              <span className="terminal-title">series/02-ai-tools.tsx</span>
            </div>
            <div className="terminal-body">
              <p><span className="prompt">$</span> ls series/02-ai-tools/</p>
