export default function Series05ContentAutomationPage() {
  return (
    <div className="container">
      ...
      <main className="main">
        <div className="page-header">
          <h1 className="page-title">Series 05 Content Automation</h1>
        ...
        <div className="content-area">
          <div className="terminal-window">
            <div className="terminal-header">
              ...
              <span className="terminal-title">series/05-content-automation.tsx</span>
            </div>
            <div className="terminal-body">
              <p><span className="prompt">$</span> ls series/05-content-automation/</p>
