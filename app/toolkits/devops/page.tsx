export default function ToolkitsDevopsPage() {
  return (
    <div className="container">
      ...
      <main className="main">
        <div className="page-header">
          <h1 className="page-title">Toolkits Devops</h1>
        ...
        <div className="content-area">
          <div className="terminal-window">
            <div className="terminal-header">
              ...
              <span className="terminal-title">toolkits/devops.tsx</span>
            </div>
            <div className="terminal-body">
              <p><span className="prompt">$</span> ls toolkits/devops/</p>
